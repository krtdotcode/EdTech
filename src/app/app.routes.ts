...
export const routes: Routes = [
  ...
  { path: 'profile-completion', loadComponent: () => import('./pages/profile-completion/profile-completion').then(m => m.ProfileCompletion), canActivate: [AuthGuard] },
  { path: 'mentee-dashboard', loadComponent: () => import('./pages/matching/matching').then(m => m.Matching), canActivate: [AuthGuard] }, // Assuming matching is mentee dashboard
  { path: 'mentor-dashboard', loadComponent: () => import('./pages/mentor-requests/mentor-requests').then(m => m.MentorRequests), canActivate: [AuthGuard] }, // Assuming mentor-requests is mentor dashboard
